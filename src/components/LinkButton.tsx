...
export function LinkButton({ children, ...linkProps }: Props) {
  return (
    <Link
      href="/simulator"
      className="inline-flex items-center justify-center p-5 text-base font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-app-midnight dark:hover:bg-app-midnight-light dark:hover:text-white mx-auto"
      {...linkProps}
    >
      <svg
        aria-hidden="true"
